    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="bg-black py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-xl font-manrope text-cyan-50">
      ...
      <main className="flex-1 bg-white">
        ...
        <div className="bg-gradient-to-b from-black to-gray-600 h-[700px] flex items-center justify-center w-full">
          <div className="text-center max-w-7xl mx-auto px-10">
            {/* Hero Image One */}
            {heroImageOne && (
            ...
            <h2 className="text-3xl font-manrope font-bold text-white mb-6">
              {home?.AirHUDHeadline || "AirHUD"}
            </h2>
            <p className="text-white font-manrope text-xl mb-10 leading-relaxed">
            ...
            <a
              ...
              className="inline-block bg-white hover:bg-brandorange text-black px-10 py-4 rounded-xl font-manrope font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl"
            >
        ...
        <div className="bg-gradient-to-b from-gray-600 to-white h-[700px] flex items-center justify-center w-full">
          <div className="text-center max-w-7xl mx-auto px-10">
            {/* Hero Image Two */}
            {heroImageTwo && (
              <div style={{textAlign: 'center', marginBottom: '24px'}}>
            ...
            <h2 className="text-3xl font-manrope font-bold text-stone-700 mb-6">
              {home?.AirSkillHeadline || "AirSkill"}
            </h2>
            <p className="text-stone-700 font-manrope text-xl mb-10 leading-relaxed">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-black hover:bg-brandorange text-white px-10 py-4 rounded-xl font-manrope font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl"
            >
